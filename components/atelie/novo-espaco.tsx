...
/**
 * E03 · split 7/5 contrastado: foto da casa nova à esquerda, texto num bloco
...
export function NovoEspaco() {
  ...
  return (
    <section className="py-16 md:py-24">
      <Container className="grid items-stretch gap-0 overflow-hidden rounded-[var(--radius-card)] md:grid-cols-12">
